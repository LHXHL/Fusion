...
use crate::{
    ...
    app::{
        ...
        runtime_relay::{
            ...
            send_direct_announce_simplex_dns,
...
pub async fn handle_inbound_task_peer_tcp(
    ...
    tokio::spawn(async move {
        loop {
            ...
            if let Err(err) = crate::app::runtime_stream::handle_mux_stream_open_tcp(
                &local_agent_id,
                stream_peer.clone(),
                open_frame,
...
pub async fn handle_inbound_task_peer_simplex_http(
    ...
    tokio::spawn(async move {
        loop {
            ...
            if let Err(err) = crate::app::runtime_stream::handle_mux_stream_open_simplex_http(
                &local_agent_id,
                stream_peer.clone(),
                open_frame,
                stream_peer_map.clone(),
...
pub async fn run_inbound_task_server_simplex_oss(
    ...
    tokio::spawn(async move {
        loop {
            ...
            if let Err(err) = crate::app::runtime_stream::handle_mux_stream_open_simplex_oss(
                &local_agent_id,
                stream_peer.clone(),
                open_frame,
                stream_peer_map.clone(),
...
pub async fn run_inbound_task_server_simplex_dns(
    ...
    tokio::spawn(async move {
        loop {
            ...
            if let Err(err) = crate::app::runtime_stream::handle_mux_stream_open_simplex_dns(
                &local_agent_id,
                stream_peer.clone(),
                open_frame,
                stream_peer_map.clone(),
...
pub async fn run_outbound_relay_peer_ws(
    ...
    tokio::spawn(async move {
        loop {
            ...
            if let Err(err) = crate::app::runtime_stream::handle_mux_stream_open_ws(
                &local_agent_id,
                stream_peer.clone(),
                open_frame,
                stream_peer_map.clone(),
